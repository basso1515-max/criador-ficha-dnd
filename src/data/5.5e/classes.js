...
export const CLASSES = {
  barbaro: {
    ...
    features: {
      ...
      5: [
        ...
        feature("Movimento Rápido", "Seu deslocamento aumenta em 3 metros enquanto não estiver usando armadura pesada."),
      ],
      7: [
  ...
  bardo: {
    ...
    features: {
      ...
      4: [feature("Aumento no Valor de Atributo", "Recebe Aumento no Valor de Atributo ou outro talento para o qual se qualifique.")],
      5: [feature("Fonte de Inspiração", "Recupera todos os usos de Inspiração de Bardo em descansos curtos ou longos e pode gastar um espaço de magia, sem ação, para recuperar um uso.")],
  ...
  clerigo: {
    ...
    features: {
      ...
      4: [feature("Aumento no Valor de Atributo", "Recebe Aumento no Valor de Atributo ou outro talento para o qual se qualifique.")],
      5: [feature("Fulminar Mortos-Vivos", "Ao usar Expulsar Mortos-Vivos, mortos-vivos que falham sofrem dano radiante igual a dados d8 em número igual ao modificador de Sabedoria, mínimo 1d8.")],
  ...
  druida: {
    ...
    features: {
      ...
      4: [feature("Aumento no Valor de Atributo", "Recebe Aumento no Valor de Atributo ou outro talento para o qual se qualifique.")],
      5: [feature("Ressurgimento Selvagem", "Uma vez em cada turno, se estiver sem usos de Forma Selvagem, pode gastar um espaço de magia para recuperar 1 uso; uma vez por descanso longo, pode gastar 1 uso para recuperar um espaço de 1º círculo.")],
  ...
  monge: {
    ...
    features: {
      ...
      5: [
        feature("Ataque Extra", "Ataca duas vezes ao usar a ação Atacar."),
        feature("Golpe Atordoante", "Uma vez por turno, ao atingir com arma de monge ou ataque desarmado, gasta 1 Foco; em falha de Constituição, o alvo fica Atordoado, e em sucesso tem o deslocamento reduzido e concede Vantagem ao próximo ataque."),
      ],
