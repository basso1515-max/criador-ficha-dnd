export const FEATURE_SUMMARIES_2024 = {
  ...
  "subclasses": {
    ...
    "guerreiro-cavaleiro-arcano": {
      ...
      "Vínculo com Arma": "Se ela estiver no mesmo plano de existência, você pode invocar essa arma como uma Ação Bônus, teleportando-a instantaneamente para sua mão",
      "Magia de Guerra": "Ao executar a ação Atacar no seu turno, você pode substituir um dos ataques por uma conjuração de um de seus truques de Mago que tenha um tempo de conjuração de uma ação",
      "Golpe Místico": "Você aprende a usar seus ataques com armas para reduzir a resistência de uma criatura às suas magias",
      "Investida Mística": "Ao usar seu Surto de Ação, pode se teleportar até 9 metros para um espaço desocupado à sua vista",
      "Magia de Guerra Aprimorada": "Ao executar a ação Atacar no seu turno, você pode substituir dois ataques pela conjuração de uma das suas magias de Mago de 1º ou 2º círculo que tenha um tempo de conjuração de uma ação"
    },
    ...
    "guerreiro-mestre-de-batalha": {
      "Estudioso da Guerra": "Ganha proficiência com um tipo de Ferramentas de Artesão à sua escolha e adquire proficiência em uma perícia à sua escolha das perícias disponíveis para Guerreiros no nível 1",
      "Superioridade em Combate": "Muitas manobras aprimoram, de alguma forma, um ataque",
      "Conheça Seu Inimigo": "Ação bônus para examinar certos pontos fortes e fracos de uma criatura à sua vista a até 9 metros de você; você sabe se essa criatura tem Imunidades, Resistências ou Vulnerabilidades, e se a criatura tiver alguma, você sabe quais são",
      "Superioridade em Combate Aprimorada": "Seu Dado de Superioridade se torna um d10",
      "Implacável": "Uma vez por turno, ao usar uma manobra, você pode jogar 1d8 e usar o resultado em vez de gastar um Dado de Superioridade",
      "Superioridade em Combate Suprema": "Ao receber dano de outra criatura em uma jogada de ataque corpo a corpo, você pode executar uma Reação e gastar um Dado de Superioridade para reduzir o dano pelo número obtido no Dado de Superioridade mais seu modificador de Força ou Destreza (à sua escolha)"
    },
    "ladino-faca-alma": {
    ...
    "ladino-trapaceiro-arcano": {
      "Conjuração": "Aprende magia de mago focada em truques, controle e furtividade arcana.",
      "Mão de Mago Legerdemain": "Sua Mão de Mago fica mais discreta e útil para furtos e truques à distância.",
      "Emboscador Mágico": "Criaturas pegas desprevenidas pelas suas magias resistem pior a elas.",
      "Trapaceiro Versátil": "Ao usar a opção Golpe Astuto em seu Ataque em uma criatura, você também pode usar essa opção em outra criatura a até 1,5 metro da mão espectral",
    ...
    "paladino-gloria": {
      ...
      "Defesa Gloriosa": "Quando você ou outra criatura à sua vista a até 3 metros de você é atingida por uma jogada de ataque, você pode executar uma Reação para conceder um bônus à CA do alvo contra esse ataque, fazendo potencialmente com que o ataque erre",
